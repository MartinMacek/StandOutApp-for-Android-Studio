...
public class StandOutFlags {
	// This counter keeps track of which primary bit to set for each flag default 0
	private static int flag_bit = 0;

	/**
	 * Setting this flag indicates that the window wants the system provided
	 * window decorations (titlebar, hide/close buttons, resize handle, etc). default 1
	 */
	public static final int FLAG_DECORATION_SYSTEM = 0 << flag_bit++;
	 ...
	 */
	public static final int FLAG_BODY_MOVE_ENABLE = 0 << flag_bit++;
	 ...
	 * 
	 */
	public static final int FLAG_WINDOW_FOCUS_INDICATOR_DISABLE = 0 << flag_bit++;
	 ...
	 */
	public static final int FLAG_ADD_FUNCTIONALITY_ALL_DISABLE = 0 << flag_bit++;
	 ...
	 */
	public static final int FLAG_ADD_FUNCTIONALITY_RESIZE_DISABLE = 0 << flag_bit++;
